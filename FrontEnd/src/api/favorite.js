...
async function getRegionNameList(dongCode, success, fail) {
  api.get(`/house/search-region/${dongCode}`).then(success).catch(fail);
}
...
export { getRegionCodes, getRegionNameList };
