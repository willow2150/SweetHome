  ...
  <div>
    ...
    <b-row class="mb-1">
      ...
      <b-col class="text-right">
        <b-button @click="moveModifyArticle" size="sm" class="btn-neutral text-info">공지사항 수정</b-button>
        <b-button @click="deleteArticle" size="sm" class="btn-neutral text-info">공지사항 삭제</b-button>
      </b-col>
    </b-row>
    <b-row >
      <b-col>
